...
abstract class LoggerFactory
{
     ...
     * @throws Exception
     */
    public static function create(string $logName, string $logType = 'main', bool $tryStdOut = true): LoggerInterface
    {
        $loggerKey = $logName . '@' . $logType;
        ...
        $logger->pushHandler(new StreamHandler($logDir . $fileAll, $minErrorType))->pushHandler(new StreamHandler($logDir . $fileError,
            Logger::ERROR));
